...
score = Label(height=50, width=80, text="Score: 00", font="Courier 14")
        ...
        while 1:
            if pole.pauseSeconds != 1:
                ...
                if not ball.bottom_hit:
                    ...
                    canvas.create_text(250, 250, text="GAME OVER!!", fill="red", font="Courier 24 ")
                    root.update_idletasks()
                    root.update()
                    playing = False
                    break
                ...
                try:
                    ...
                    m = canvas.create_text(250, 250, text="PAUSE!!", fill="green", font="Courier 24 ")
                root.update_idletasks()
                root.update()


root.bind_all("<Return>", start_game)
canvas.create_text(250, 250, text="Press Enter to start Game!!", fill="Green", font="Courier 18")
j = canvas.find_all()
root.mainloop()
